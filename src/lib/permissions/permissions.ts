...
export const PERMISSIONS = {
  ...
  SHIPPING_NOTES_APPROVE: "shipping-notes:approve",
  SHIPPING_NOTES_LOCK: "shipping-notes:lock",
  SHIPPING_NOTES_UNLOCK: "shipping-notes:unlock",
  SHIPPING_NOTES_CANCEL: "shipping-notes:cancel",
  SHIPPING_NOTES_CANCEL_FINALIZED: "shipping-notes:cancel-finalized",
  SHIPPING_NOTES_REOPEN_FOR_CORRECTION: "shipping-notes:reopen-for-correction",
  ACCOUNTING_READ: "accounting:read",
  BUYING_CHARGES_READ: "buying-charges:read",
  BUYING_CHARGES_MANAGE: "buying-charges:manage",
  BUYING_CHARGES_OPS_INPUT: "buying-charges:ops-input",
