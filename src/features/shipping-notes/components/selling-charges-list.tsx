...
function EditChargeRow({ charge, shippingNoteId, onCancel }: EditChargeRowProps) {
  ...
  return (
    <tr className="bg-slate-50 dark:bg-slate-900/60">
      <td colSpan={10} className="border-b border-slate-200 dark:border-slate-800 px-3 py-3">
...
export function SellingChargesList({
  ...
  if (charges.length === 0) {
    return <p className="text-sm text-slate-500 dark:text-slate-400">No selling charges yet.</p>;
  }
