...
export const quickCreatePartnerInputSchema = createPartnerInputSchema.pick({
  companyName: true,
  vendorCode: true,
  address: true,
  taxId: true,
...
export type QuickCreatePartnerInput = z.input<typeof quickCreatePartnerInputSchema>;
